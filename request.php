                ...
                <tr>
                    ...
                    <th>Pick-up Place</th>
                     ...
                     <?php
                      ...
                      $sql="SELECT withdraw.withdraw,member.fn, member.mn, member.ln, withdraw.dat,withdraw.reg,member.ad  FROM withdraw join member on withdraw.id=member.uid where withdraw.stat='' ";
                      ...
                      echo"<tr>";
                          ...
                          echo"<td>"; 
                          echo '<input type="checkbox" name="check_list[]" value="'.$row['reg'].'">';
                          echo"</td>";
                    ...
                    <input type="submit" name="submit" Value="CASHOUT"class="md-trigger btn btn-primary mrg-b-lg"/>
                            ...
                            $results2 = $conn->query("UPDATE withdraw SET stat='done' where reg='$selected'");    
