    ...
    $fulln= $row['fn'].' '.$row['mn'].' '.$row['fn']; 
                       ...
                       $sql="SELECT * FROM member where sid='$id'";
                        ...
                        $sql = "SELECT * FROM member where uid='$id'";
                            ...
                            $autogen=$row['regen'];
                           // echo "<script>alert('$autogen');</script>";
                            ...
                            $row = mysqli_fetch_assoc($result);
                            $maxreg=$row['maxid'];
                           // echo "<script>alert('$maxreg');</script>";
...
<head>
  ...
  <title>Bonus Share | Natural Herbs</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini">Bonus Share</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Bonus Share</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="bonushare.php"><i class="fa fa-table"></i> <span>Bonus Share</span></a></li>
  ...
  <form method="post">  
    <section class="content">
        ...
        <div class="row">
            ...
            <h3 class="no-margins font-extra-bold text-success">HISTORY <div id="lvl"></div> &nbsp; </h4>
              <hr>
              ...
              <div class="col-lg-10 col-xs-6">
                ...
                <tr>
                   ...
                   //  uid='$id'
                     ...
                     while($row = mysqli_fetch_array($result)) {
                       ...
                       $tot += $reward=20/$cmem;
                        ...
                        echo"<tr>";
                           ...
                           echo'<h4 class="no-margins font-extra-bold text-success">'.$reward.'</h4></div>';  
                    ...
                    ?>
                    <tfoot>
                        <tr><td><h3>Total : <?php echo '₱' . number_format($tot,2,'.',','); ?> </td></tr>
                     </tfoot>   
...
<footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2017 <a href="#">MyNaturesWealth Corp</a>.</strong> All rights reserved.
  </footer>
