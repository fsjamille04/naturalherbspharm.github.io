        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Admin ID</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="login1.php" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
          ...
          <li>
            <a href="login1.php"><i class="fa fa-gears"></i></a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="updateadmin.php"><i class="fa fa-gears"></i> <span>Change Password</span></a></li>       
        ...
        <li><a href="secode.php"><i class="fa fa-gears"></i> <span>Generate Codes</span></a></li>
        ...
        <li><a href="member.php"><i class="fa fa-money"></i> <span>List of Member</span></a></li>
...
<div class="content">
    ...
    <div class="col-lg-8">
        <div class="content">
            <div class="hpanel">
                ...
                <div class=""><h3>Edit Admin Account</h3>
                    ...
                    <div class="panel-body no-padding">
                        <div class="panel-body">
                            <form method="POST">
                                            ...
                                            <input type="text" value="" id="password" class="form-control" name="password" required="">
                                            </div>

                                            

                                             <div class="form-group col-lg-8">
                                            <button class="btn btn-success col-lg-12" name="register4" id="register4">Save Changes</button>
  ...
  $password = $_POST['password'];
    ...
    $res = $conn->query("SELECT uname FROM admin WHERE uname = '$uname'");
    ...
    $sql = "UPDATE admin SET uname = '$uname', password = '$password' WHERE adminid='$adminid'";
    $conn->query($sql);
