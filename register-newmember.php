...
<div class="wrapper" style="height: auto;">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="https://naturalherbspharm.org/" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini">Natural Herbs Pharm</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Natural Herbs Pharm</span>
    </a>
    <!-- Header Navbar -->
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <!-- User Account Menu -->
            ...
            <!-- Menu Toggle Button -->
            <a href=""> <span class="hidden-md">Login Here</span></a>
  ...
  <div class="" style="min-height: 286px;">
...
<div class="row">
  ...
  <div class="register-box-body">
    ...
    <div class="form-group has-feedback">
      ...
      <div class="row text-center">
          <div class="col-md-12"><a href="https://naturalherbspharm.org/system/login.php">Click here to Login</a></div>
      </div>
<?php
            ...
            if($hid=='2'){
                              $x=5;
                                         ...
                                         $results = $conn->query("UPDATE indirect SET one='$sumra' where id =  '$hid' and YEAR(dat) = '$year' and MONTH(dat) = '$month'"); 
                                          ...
                                          $sql = "INSERT IGNORE INTO indirect (one,two,three,four,id,dat)
                                          VALUES ('25','0','0','0','$hid','$hdat')";
                                          if ($conn->query($sql) === TRUE) {                         
...
<!-- jQuery 2.2.3 -->
<script async="" src="//www.google-analytics.com/analytics.js"></script><script async="" src="//www.google-analytics.com/analytics.js"></script><script src="plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- jQuery UI 1.11.4 -->
...
</div><div class="jvectormap-label"></div><div class="jvectormap-label"></div></body></html>