  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="stuff-dashboard.php"><i class="fa fa-home"></i> <span>Admin Dashboard</span></a></li>
        <li class="active"><a href="member12.php"><i class="fa fa-link"></i> <span>List of Members</span></a></li>
