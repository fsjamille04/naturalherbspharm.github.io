...
<head>
  ...
  <title>UniLevel Tree | Natural Herbs</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.html" class="logo">
      ...
      <span class="logo-mini">Unilevel</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Unileve</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="indirect.php"><i class="fa fa-group"></i> <span>Unilevel tree</span></a></li>
  ...
  <form method="post">  
    <section class="content">
        ...
        <div class="row">
            ...
            <h3 class="no-margins font-extra-bold text-success">Level <div id="lvl"></div> &nbsp; </h4>
              <hr>
             <div class="col-lg-2 col-xs-12">
              <input type="button" class="btn btn-primary"name="save"id="save"value="Next">
